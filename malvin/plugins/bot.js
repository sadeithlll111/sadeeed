...
async (conn, mek, m, { from, quoted, body, isCmd, command, args, q, isGroup, sender, senderNumber, botNumber2, botNumber, pushname, isMe, isOwner, groupMetadata, groupName, participants, groupAdmins, isBotAdmins, isAdmins, reply }) => {
 ...
 try {
        let dec = `*𝐇𝐞𝐥𝐥𝐨 𝐭𝐡𝐞𝐫𝐞 NATHAN 𝐖.𝐀 𝐁𝐨𝐭 𝐔𝐬𝐞𝐫! 👋* 

*𝑇𝒉𝑎𝑛𝑘𝑠 𝑓𝑜𝑟 𝑈𝑠𝑖𝑛𝑔 NATHAN * 

> Don't forget to star & fork the repo🌟🍴

https://github.com/LUXXY4
──────────────────
'`;

        await conn.sendMessage(from, { image: { url: `https://files.catbox.moe/t5jj6j.jpg` }, caption: dec, contextInfo: { mentionedJid: [m.sender], forwardingScore: 999, isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: '120363306168354073@newsletter', newsletterName: '『 ᴍᴀʟᴠɪɴ xᴍᴅ 』', serverMessageId: 143 } } }, { quoted: mek });
