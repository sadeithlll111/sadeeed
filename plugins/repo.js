...
async (conn, mek, m, { from, quoted, body, isCmd, command, args, q, isGroup, sender, senderNumber, botNumber2, botNumber, pushname, isMe, isOwner, groupMetadata, groupName, participants, groupAdmins, isBotAdmins, isAdmins, reply }) => {
 ...
 try {
        let dec = `*𝐇𝐞𝐥𝐥𝐨 𝐭𝐡𝐞𝐫𝐞 SADE 𝐖.𝐀 𝐁𝐨𝐭 𝐔𝐬𝐞𝐫! 👋* 

*𝑇𝒉𝑎𝑛𝑘𝑠 𝑓𝑜𝑟 𝑈𝑠𝑖𝑛𝑔 𝑴𝒂𝒍𝒗𝒊𝒏 𝑿𝑴𝑫 🫶* 


https://github.com/LUXXI4
──────────────────
'`;

        await conn.sendMessage(from, { image: { url: `hhttps://files.catbox.moe/t5jj6j.jpg` }, caption: dec, contextInfo: { mentionedJid: [m.sender], forwardingScore: 999, isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: '120363306168354073@newsletter', newsletterName: '『 SADE 』', serverMessageId: 143 } } }, { quoted: mek });
...
async (conn, mek, m, { from, reply }) => {
    const githubRepoURL = 'https://github.com/LUXXI4';
    ...
    try {
        ...
        const formattedInfo = `*ʜᴇʟʟᴏ ᴛʜᴇʀᴇ, SADE ᴜsᴇʀ! 👋* 

*𝑇𝒉𝑎𝑛𝑘𝑠 𝑓𝑜𝑟 𝑢𝑠𝑖𝑛𝑔 SADE🌹🫶* 
