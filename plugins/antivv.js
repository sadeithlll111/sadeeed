...
cmd({
  ...
  try {
    ...
    if (!_0x1759df.quoted) {
      return _0x5545e9("Please reply to a ViewOnce message dumbass.");
    }
    if (_0x1759df.quoted.mtype === "viewOnceMessage") {
      ...
      if (_0x1759df.quoted.message.audioMessage) {
        ...
        return _0x5545e9("> *This is not a ViewOnce message dumbfuck.*");
      }
    }
  } catch (_0x23e307) {
    console.log('Error:', _0x23e307);
    _0x5545e9("An error occurred while fetching the ViewOnce message i hate this bot oml.");
  }
});